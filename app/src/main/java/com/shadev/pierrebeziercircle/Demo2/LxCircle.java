 ...
 */
public class LxCircle extends View {
    public LxCircle(Context context) {
        super(context);
        init();
    }
    ...
    public LxCircle(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public LxCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
